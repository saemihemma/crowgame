...
const BOXES = {
    ...
    'level.level_06.name': { size: 20, max: 240, where: 'Level node name, label start to padlock' },
    'level.level_07.name': { size: 20, max: 240, where: 'Level node name, label start to padlock' },
    'level.level_08.name': { size: 20, max: 240, where: 'Level node name, label start to padlock' },
