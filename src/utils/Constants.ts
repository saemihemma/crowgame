...
export const DATA_PATHS = {
    ...
    THEME_EMBERWOOD: 'data/themes/theme_emberwood.json',
    THEME_PRISM_HOLLOW: 'data/themes/theme_prism_hollow.json',
    THEME_SUGARSTORM: 'data/themes/theme_sugarstorm.json',
    THEME_GEYSERWORKS: 'data/themes/theme_geyserworks.json',
    THEME_AURORA_SPIRE: 'data/themes/theme_aurora_spire.json',
    ...
    TILESET_MANIFEST: 'data/tilesets/tileset_manifest.json',
} as const;
